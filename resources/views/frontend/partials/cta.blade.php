    ...
    <div class="container">
        ...
        <div class="row text-center justify-content-center mb-lg-3">
            ...
            <div class="col-12 col-lg-6 text-lg-left  mb-3 mb-lg-0 gs_reveal gs_reveal_fromRight">
                <a class="btn btn-primary btn-cta border" href="{!! _i("//www.fiat.co.uk/quote-request").'?source=brochure' !!}" target="_blank">
        ...
        <div class="row text-center justify-content-center">
            ...
            <div class="col-12 col-lg-6 text-lg-left gs_reveal gs_reveal_fromRight">
                <a class="btn btn-primary btn-cta border"  href="{!! _i("//www.fiat.com/where-we-are").'?source=brochure' !!}" target="_blank">
